...
export default async function Raiz({
  ...
  return (
    <>
      ...
      {/*
        Tráfego marcado abre DIRETO na primeira cena.

        A landing explicativa ficava entre o anúncio e a pergunta, e era
        material demais para quem ainda não decidiu nada — os doze familiares,
        o método, o preço. Tudo isso deixa o cérebro calcular o que vem no fim
        antes de chegar lá, e quem calcula fecha a aba.

        Sem marcador, a landing continua: ali é quem digitou o endereço, foi
        indicado, ou está voltando — e essa pessoa precisa das respostas.
      */}
      {viaMarcador ? <PortaDoRitual /> : <Landing />}
    </>
  );
}
